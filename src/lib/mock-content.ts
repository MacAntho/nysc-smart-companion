...
1. MANDATORY ACCOUNTS: Most states use specific banks (Access, FirstBank, Zenith, Zenith, UBA).
...
export const CDS_RESOURCES = {
  ...
  projects: [
    // --- EDUCATION (6) ---
    {
      ...
      description: 'Establishing a community library with donated books to improve literacy in underserved regions.',
      budget: '₦120,000 - ₦250,000',
      duration: '4 Months',
      requirements: ['Community Space', 'Book Donations', 'LGI Approval', 'Volunteer Librarians'],
    },
    {
      id: 'edu-2',
      category: 'Education',
      title: 'ICT Literacy Boot Camp',
      description: 'A 6-week intensive basic computer skills program for local secondary school students.',
      budget: '₦80,000 - ₦150,000',
      duration: '2 Months',
      requirements: ['Laptops/PCs', 'Training Manuals', 'Generator', 'Venue with Power'],
    },
    {
      id: 'edu-3',
      category: 'Education',
      title: 'Science Lab Rehabilitation',
      description: 'Refurbishing a dilapidated science laboratory and providing basic chemical reagents.',
      budget: '₦300,000 - ₦600,000',
      duration: '5 Months',
      requirements: ['Technical Assessment', 'Sponsorship', 'Safety Equipment', 'School MOU'],
    },
    {
      id: 'edu-4',
      category: 'Education',
      title: 'Adult Education Classes',
      description: 'Evening literacy and numeracy classes for local artisans and market women.',
      budget: '₦40,000 - ₦90,000',
      duration: '6 Months',
      requirements: ['Teaching Materials', 'Local Chief Permission', 'Volunteer Tutors'],
    },
    {
      id: 'edu-5',
      category: 'Education',
      title: 'Career Guidance Hub',
      description: 'Setting up a permanent career resource center with university guides and job application tips.',
      budget: '₦150,000 - ₦200,000',
      duration: '3 Months',
      requirements: ['Internet Access', 'Resource Books', 'Desktop PC', 'Office Furniture'],
    },
    {
      id: 'edu-6',
      category: 'Education',
      title: 'Mathematics Improvement Program',
      description: 'Special weekend coaching for students struggling with WAEC/NECO mathematics.',
      budget: '₦50,000 - ₦80,000',
      duration: '4 Months',
      requirements: ['Stationery', 'Whiteboards', 'Student Database'],
    },
    // --- HEALTH (6) ---
    {
      id: 'health-1',
      ...
      description: 'Distribution of mosquito nets and environmental clearing to reduce malaria vectors.',
      budget: '₦200,000 - ₦400,000',
      duration: '3 Months',
      requirements: ['LLIN Nets', 'Health Education Materials', 'Local PHC Partner'],
    },
    {
      id: 'health-2',
      category: 'Health',
      title: 'Maternal Health Outreach',
      description: 'Workshops for expectant mothers on prenatal care and hygiene.',
      budget: '₦100,000 - ₦180,000',
      duration: '4 Months',
      requirements: ['Delivery Kits', 'Nutrition Supplements', 'PHC Approval'],
    },
    {
      id: 'health-3',
      category: 'Health',
      title: 'First Aid Training Hub',
      description: 'Training community leaders and teachers in basic life-saving techniques.',
      budget: '₦60,000 - ₦120,000',
      duration: '2 Months',
      requirements: ['Training Mannequin', 'First Aid Kits', 'Certified Trainer'],
    },
    {
      id: 'health-4',
      category: 'Health',
      title: 'Water Sanitization Project',
      description: 'Teaching rural communities how to use Chlorine and Biosand filters for safe water.',
      budget: '₦150,000 - ₦300,000',
      duration: '4 Months',
      requirements: ['Water Testing Kits', 'Chlorine Tabs', 'Community Workshop Venue'],
    },
    {
      id: 'health-5',
      category: 'Health',
      title: 'Mental Health Awareness',
      description: 'Destigmatizing mental illness through community dialogues and school seminars.',
      budget: '₦40,000 - ₦70,000',
      duration: '3 Months',
      requirements: ['Pamphlets', 'Expert Speakers', 'Radio Airtime (Optional)'],
    },
    {
      id: 'health-6',
      category: 'Health',
      title: 'Blood Donation Drive',
      description: 'Partnering with the National Blood Service to organize a mass donation event.',
      budget: '₦30,000 - ₦60,000',
      duration: '1 Month',
      requirements: ['NBTS Team', 'Refreshments for Donors', 'Security'],
    },
    // --- ENVIRONMENT (6) ---
    {
      id: 'env-1',
      ...
      description: 'Establishing collection points for PET bottles and partnering with recyclers.',
      budget: '₦100,000 - ₦250,000',
      duration: '6 Months',
      requirements: ['Waste Bins', 'Branding Materials', 'Recycling Truck Partner'],
    },
    {
      id: 'env-2',
      category: 'Environment',
      title: 'Tree Planting Initiative',
      description: 'Planting 500 economic trees to fight erosion and provide future shade.',
      budget: '₦70,000 - ₦140,000',
      duration: '5 Months',
      requirements: ['Saplings', 'Fencing Materials', 'Community Guards'],
    },
    {
      id: 'env-3',
      category: 'Environment',
      title: 'Drainage Clearing Campaign',
      description: 'Coordinated community effort to clear blocked gutters and prevent flooding.',
      budget: '₦50,000 - ₦100,000',
      duration: '2 Months',
      requirements: ['Protective Gear', 'Shovels/Wheelbarrows', 'Local Govt Support'],
    },
    {
      id: 'env-4',
      category: 'Environment',
      title: 'Erosion Control Wall',
      description: 'Constructing minor retaining walls in erosion-prone hilly terrains.',
      budget: '₦400,000 - ₦800,000',
      duration: '6 Months',
      requirements: ['Cement/Stone', 'Civil Engineer Consult', 'LGI Special Permit'],
    },
    {
      id: 'env-5',
      category: 'Environment',
      title: 'Clean Market Advocacy',
      description: 'Weekly sanitation drives in local markets combined with vendor education.',
      budget: '₦30,000 - ₦60,000',
      duration: '6 Months',
      requirements: ['Brooms/Trash Bags', 'Megaphone', 'Market Leader Approval'],
    },
    {
      id: 'env-6',
      category: 'Environment',
      title: 'Composting Training',
      description: 'Teaching local farmers how to convert organic waste into high-quality fertilizer.',
      budget: '₦40,000 - ₦80,000',
      duration: '3 Months',
      requirements: ['Compost Bins', 'Organic Waste Source', 'Agricultural Extensionist'],
    },
    // --- INFRASTRUCTURE (6) ---
    {
      id: 'infra-1',
      ...
      duration: '3 Months',
      requirements: ['Solar Poles', 'Maintenance Training', 'Community Security'],
    },
    {
      id: 'infra-2',
      category: 'Infrastructure',
      title: 'Well Rehabilitation',
      description: 'Repairing broken community wells and installing new pulleys/covers.',
      budget: '₦120,000 - ₦220,000',
      duration: '4 Months',
      requirements: ['Plumbing Parts', 'Masonry Work', 'Water Purity Test'],
    },
    {
      id: 'infra-3',
      category: 'Infrastructure',
      title: 'School Desk Fabrication',
      description: 'Constructing 50 new dual desks for a local school where students sit on the floor.',
      budget: '₦300,000 - ₦500,000',
      duration: '3 Months',
      requirements: ['Wood/Metal Sourcing', 'Carpentry Contract', 'LGI Verification'],
    },
    {
      id: 'infra-4',
      category: 'Infrastructure',
      title: 'Pedestrian Bridge Repair',
      description: 'Reinforcing small wooden or metal community bridges for pedestrian safety.',
      budget: '₦250,000 - ₦400,000',
      duration: '4 Months',
      requirements: ['Welding Equipment', 'Structural Check', 'Materials'],
    },
    {
      id: 'infra-5',
      category: 'Infrastructure',
      title: 'VIP Toilet Construction',
      description: 'Building ventilated improved pit latrines in public spaces to end open defecation.',
      budget: '₦500,000 - ₦1,000,000',
      duration: '6 Months',
      requirements: ['Land Approval', 'Masonry', 'Plumbing'],
    },
    {
      id: 'infra-6',
      category: 'Infrastructure',
      title: 'Public Signage System',
      description: 'Erecting directional and safety signs throughout the community.',
      budget: '₦80,000 - ₦150,000',
      duration: '2 Months',
      requirements: ['Metal Sheet', 'Reflective Paint', 'Permission to Install'],
    },
    // --- SOCIAL (6) ---
    {
      id: 'social-1',
      category: 'Social',
      title: 'GBV Advocacy Program',
      description: 'Awareness workshops on Gender Based Violence and victim support systems.',
      budget: '₦60,000 - ₦110,000',
      duration: '4 Months',
      requirements: ['Police/Legal Partners', 'Leaflets', 'Secure Venue'],
    },
    {
      id: 'social-2',
      category: 'Social',
      title: 'Legal Aid Clinic',
      description: 'Pro-bono legal counseling sessions (for Law Corpers) for the indigent.',
      budget: '₦20,000 - ₦50,000',
      duration: '6 Months',
      requirements: ['Legal Practicing Cert', 'NBA Liaison', 'Quiet Office Space'],
    },
    {
      id: 'social-3',
      category: 'Social',
      title: 'Youth Skills Empowerment',
      description: 'Vocational training in tailoring, baking, or bead making for unemployed youth.',
      budget: '₦150,000 - ₦300,000',
      duration: '5 Months',
      requirements: ['Training Equipment', 'Skill Instructors', 'Micro-Grant Partner'],
    },
    {
      id: 'social-4',
      category: 'Social',
      title: 'Drug Abuse Seminar',
      description: 'High-impact drug prevention workshops for secondary schools.',
      budget: '₦40,000 - ₦90,000',
      duration: '3 Months',
      requirements: ['NDLEA Partnership', 'Documentaries', 'Student Materials'],
    },
    {
      id: 'social-5',
      category: 'Social',
      title: 'Orphanage Support Drive',
      description: 'Structured donation and educational support system for local orphanages.',
      budget: '₦100,000 - ₦200,000',
      duration: '6 Months',
      requirements: ['Inventory List', 'Donor Database', 'Verified NGOs'],
    },
    {
      id: 'social-6',
      category: 'Social',
      title: 'Sports for Peace Tournament',
      description: 'Using community football to foster unity among conflicting local groups.',
      budget: '₦150,000 - ₦250,000',
      duration: '2 Months',
      requirements: ['Pitches', 'First Aid Team', 'Medals/Trophies'],
    }
  ],
  templates: [
